...
if(isset($_POST["submit"])){
    ...
    if($jumlah_data>=1){
    $pesan_error.="NIM yang sama telah digunakan <br>";
}
...
switch($fakultas){
    ...
    case"FASILKOM"  :$select_fasilkom ="selected";break;
}
...
//gabungkan format tanggal agar sesuai dengan date MySQL
    ...
    //form belum disumbit atau halaman ii tampil untuk pertama kali
...
<html lang="id">
    <head>
        <meta charset="UTF-8">
        <title>Sistam Informasi Mahasiswa</title>
...
?>
<form id="form_mahasiwa" action="tambah_mahasiswa.php" method="post">
    <fieldset>
        <legend>Mahasiswa Baru</legend>
        <p>
            <label for="nim">NIM : </label>
            <input type="text" name="nim" id="nim" value="<?php echo $nim ?>"
            <pleaceholder="Contoh: 12345678">
            (8 digit angka)
</p>
<p>
...
<div id="footer">
    Copyright&copy<?php echo date("Y");?>Dinilaikom
</div>
