...
<div id="header">
    ...
    <nav>
        <ul>
            <li><a href="tampilan_mahasiswa.php">Tampil</a></li>
...
//buatlah perulangan untuk element tabel dari data mahasiswa
while($data=mysqli_fetch_assoc($result))
    {
        //konversi ke MySQL(yyyy-mm-dd)menjadi dd-mm-yyyy
    ...
    <div id="footer">
        Copyright &copy<?php echo date("Y");?>Diniaikom
</div>
</div>
</body>
</html>